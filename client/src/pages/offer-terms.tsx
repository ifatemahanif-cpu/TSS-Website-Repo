...
const CLAUSES: Clause[] = [
  ...
  },
  {
    title: "7. Revisions",
    body: [
      "The fee includes two (2) rounds of revisions on copy and two (2) rounds of revisions on design, counted across the website as a whole and not per page. A round means a single consolidated set of comments from your named decision-maker, sent at one time. Further comments that arrive after a round has been actioned count as the next round.",
