...
const inputStyle: React.CSSProperties = {
  ...
  fontSize: "0.9rem",
  color: "#FDE8E9",
  backgroundColor: "rgba(253, 232, 233, 0.04)",
    ...
    <div>
      ...
      <input
        ...
        onFocus={e => {
          ...
          e.currentTarget.style.backgroundColor = "rgba(253, 232, 233, 0.06)";
        }}
        onBlur={e => {
          e.currentTarget.style.borderColor = "rgba(123, 30, 122, 0.3)";
          e.currentTarget.style.backgroundColor = "rgba(253, 232, 233, 0.04)";
        }}
        data-testid={testId}
      />
    </div>
            ...
            >
              ...
              {talkSubmitted ? (
                ...
                <form onSubmit={handleTalkSubmit} data-testid="form-talk">
                  <div
                    style={{
                      backgroundColor: "rgba(253, 232, 233, 0.02)",
