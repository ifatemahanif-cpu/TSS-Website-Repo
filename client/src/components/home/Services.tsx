            ...
            {services.map((service, idx) => {
              ...
              return (
                <motion.div
                  ...
                  style={{
                    border: `1px solid ${isExpanded ? "rgba(123, 30, 122, 0.4)" : "rgba(12, 10, 62, 0.12)"}`,
                    borderRadius: "12px",
                    overflow: "hidden",
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <motion.div
                        ...
                        style={{
                          ...
                          height: "24px",
                          borderRadius: "50%",
                          border: `1.5px solid ${isExpanded ? "#7B1E7A" : "rgba(12, 10, 62, 0.2)"}`,
                          display: "flex",
                          alignItems: "center",
                      ...
                      >
                        <span
                          style={{
                            fontSize: "0.9rem",
                            color: isExpanded ? "#7B1E7A" : "rgba(12, 10, 62, 0.4)",
                            lineHeight: 1,
                            fontWeight: 300,
                          }}
                        >
